...
def DrawChart(mydict, title, userinput):
  ...
  #          """Override plot so that line is closed by default"""
    ...
    def input():
        ...
        for key in mydict:
            thelist.append(int(raw_input("Rate your %s (1-7): " %key)))
      
        #_var = int(raw_input("Confidence "))
        #_var2 = int(raw_input("Transparency "))
        #_var3 = int(raw_input("Integrity "))
        #_var4 = int(raw_input("Inspiration "))
        #_var5 = int(raw_input("Passion "))
        #_var6 = int(raw_input("Innovation "))
        #return _var, _var2, _var3, _var4, _var5, _var6
        return thelist
    ...
    def example_data():
        ...
        print("Your average %s")%total
        print("Ideal score %s")%ideal_num
        
        if total > ideal_num:
            print("You are a good leader")
        else:
            print("You are a bad leader")
  ...
  #      print(data)
        #var , var2, var3, var4,var5,var6 = 1,2,3,4,5,6

        #data = [
        #    ['Confidence', 'Transparency', 'Integrity', 'Inspiration', 'Passion', 'Innovation'],
        #    ('What Makes A Good Leader', [[var, var2, var3, var4, var5, var6],[8,5,7,7,5,5]])
        #]
...
my_dict = {'Leadership': 5, 'Stronghold': 6, 'Foo': 3, 'Bar' : 5, 'Test1' : 6, 'Test2' : 7}



DrawChart(my_dict, 'What Makes a leader good')
